---
title: Work Permit & Business Visa Support
description: Seamless immigration and labor solutions for expatriates and international investors in Nepal.
icon: 🛂
...
```mermaid
graph TD
    A[FDI Approval/Registration] --> B[Visa Recommendation - DOI]
    B --> C[Work Permit Approval - Labor Office]
    C --> D[Visa Issuance - Immigration]
    D --> E[Income Tax ID - PAN Registration]
