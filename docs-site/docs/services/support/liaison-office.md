---
title: Liaison & Branch Office Setup
description: Specialized entry solutions for multinational companies to establish a legal presence in Nepal.
icon: 🏢
...
```mermaid
graph TD
    A[Multinational Head Office] --> B{Entry Type?}
    B -- Non-Profit/Marketing --> C[Liaison Office - DOI]
    B -- Commercial/Contract --> D[Branch Office - OCR]
    C & D --> E[PAN/VAT Registration]
    E --> F[NRB Foreign Currency Approval]
