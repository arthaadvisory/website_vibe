...
description: Comprehensive statutory audit, internal audit, IS audit, forensic investigation, and specialized sector audit services in Nepal.
sidebar: false
parent: Services|/services/
layout: doc
category: Core Assurance & Tax
icon: 🔍
heroImage: /images/headers/service-audit.jpg
steps:
  - title: Engagement & Planning
    description: Initial client meeting, understanding the business model, and identifying key risk areas based on industry standards.
  - title: Internal Control Review
    description: Evaluating the design and execution of internal controls to determine the reliance we can place on automated systems.
  - title: Execution & Testing
    description: Performing substantive audit procedures, data analytics, and verification of high-value transactions.
  - title: Reporting & Finalization
    description: Issuance of independent auditor's report and management letter highlighting operational improvements.
---
...
graph LR
    ...
    TB[Trial Balance] --> LED[General Ledgers]
    LED --> INV[Invoices & Vouchers]
    end
    
    subgraph External Audit Evidence
    CON[Bank Confirmations]
    DIR[Debtor/Creditor Verification]
    PHY[Physical Inspection]
    end
    
    subgraph Artha Audit Engine
    TB & CON --> RECON[Automated Reconciliation]
    RECON --> AN[Analytical Procedures]
    AN --> REP[Final Audit Report]
    end
    
    style REP fill:#147d34,stroke:#fff,color:#fff
```
